...
(Reser, 2022)\cite{Reser_2022}设计一套维果茨基的自主人工智能体，能够与他人互动，更重要的是，能够将这些互动内在化，将其转化为支持新认知功能发展的认知工具#NOW

(Colas et al., 2022)\cite{Colas.Karch.ea_2022}

(Liang, 2022) \cite{Liang_2022}提出了一种多模态（以视觉和自然语言二模态为例）转换方式。设计了一种多模态语言学习框架：编码->表示空间->解码。此外，设计对应的多模态处理器：视听处理器、语言视觉处理器、情绪处理器、建模世界处理器（多主体强化学习相关）、内在语言视觉触觉感受器（编码后之表现形式）
